...
TextSpacing=10; // [6 : 20]
// The fontface to use
Font = "write/Letters.dxf"; // ["write/BlackRose.dxf":BlackRose,"write/braille.dxf":braille,"write/knewave.dxf":knewave,"write/Letters.dxf":Letters,"write/orbitron.dxf":orbitron]

/* [Coin] */

// Type of coin to use
CoinType = "XX"; // [US:US 1 Cent, CA:CA 1 Cent, EU:EU 5 Cent, UK:UK 1 Penny, XX:Manual]
// Manual coin radius
ManualRadius=21.2/2;
